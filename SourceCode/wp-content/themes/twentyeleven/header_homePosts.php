<body <?php body_class(); ?>>
	<div id="page" class="hfeed" style="<?php
	// if($_GET["page_id"]==11) echo "height: 1300px;";
	// elseif($_GET["page_id"]==5) echo "height: 1416px;";
	// elseif($_GET["page_id"]!="") echo "height: 1480px;";
?>">
		<header id="branding" <?php if($_GET["page_id"]!=""){ ?>class="clearfix"<?php } ?> role="banner">
		<div id="Header_Logo">
		<a href="./?"><img src="./CMS_Images/hyro-logo.jpg" /></a>
		</div>
		<hgroup>
		<?php /* <h1 id="site-title"><span><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?><
		/a></span></h1> */ ?>
...
$header_image_width = HEADER_IMAGE_WIDTH;
		...
		<nav id="access" role="navigation">
			...
			<?php 
			// add the + to the Menu by jQuery ?>
		</nav><!-- #access -->
		<script>
			// document.getElementByTagName("div").$(".menu").getElementByTagName("ul").getElementByTagName("li").getElementByTagName("a").style.text-transform = 'uppercase';
		</script>
...
?>
		...
		//the sliders widget
			...
			?>position: relative; width: 1000px; <?php
			...
			<div>
				...
				<ul class="slides" style="position: relative; overflow: hidden; height: 320px; width: 100%; ">
					...
					<li style="top: 0px; left: 0px; position: absolute; width: 1000px; height: 320px; display: block; z-index: 2; opacity: 1; ">
						<article class="wk-content clearfix"><a href="./?page_id=5"><img src="http://nikoms-ubuntu:83/wordpress9/wp-content/uploads/2012/07/Feature-1.2.jpg" alt="" title="Feature-1.2" width="1000" height="320" class="wp-image-31"></a></article>
					</li>
					<li style="top: 0px; left: 0px; position: absolute; width: 1000px; height: 320px; display: none; z-index: 1; opacity: 1; ">
						<article class="wk-content clearfix"><a href="./?page_id=5"><img src="./CMS_Images/Feature-1.3.png" data-src="./CMS_Images/Feature-1.3.png" class="wp-image-22"></a></article>
					</li>
				</ul>
				<div class="next"></div><div class="prev"></div>
				<div class="caption" style="display: block; ">Basic Android Application Development</div>
				<ul class="captions" style="display: none; ">
					<li>Basic Android Application Development</li>
					<li>Slider 2</li>
				</ul>
			</div>
		</div>
...
?>
		...
		?>
		<div id="Header_Caption2" class="clearfix">
		<?php
}
		?>
		<div id="block1">
	 ...
	 <?php
		...
		?>
		<div id="main" class="clearfix" style ="<?php
		if ($_GET["page_id"] == 236 || $_GET["submit"] == "Search")
			echo "top: 50px; ";
